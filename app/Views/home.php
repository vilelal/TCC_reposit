            ...
            <div class="titulo-ad">
                ...
                <div class="testimonials-container">
                    ...
                    <div class="testimonial-card">
                        <h4><img src="app/css/img/icone-user.png" alt="">Mario Fernandez <img class="star" src="app/css/img/icone-estrela.png" alt=""> 4.9</h4>
                        <p class="comentario">Uma das melhores decisões que tomei foi me cadastrar na FastService!! Desde os primeiros dias, os números de
                            clientes e serviços realizados só vem aumentando mais!!</p>
                    </div>

                    <div class="testimonial-card">
                        <h4><img src="app/css/img/icone-user.png" alt="">Jéssica Silva <img class="star" src="app/css/img/icone-estrela.png" alt=""> 4.8</h4>
                        <p class="comentario">Sem dúvidas é algo que realmente faz a diferença no meu
                    ...
                    <div class="testimonial-card">
                        <h4><img class="user" src="app/css/img/icone-user.png" alt="">Cléber Santos <img class="star" src="app/css/img/icone-estrela.png" alt=""> 4.7</h4>
                        <p class="comentario">Além de ser uma plataforma que de muita visibilidade, é
                            interessante como ajuda muito com dados, ela apresenta números de serviços, estatísticas em geral e outras funcões</p>
                    </div>
                </div>
